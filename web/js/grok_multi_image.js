// Grok 多圖上傳 — 前端擴充(介面仿 MultiImageLoader:
...
const NODE_CLASS = "GrokMultiImageNode";
const UPLOAD_SUBFOLDER = "grok_refs";
const ACCEPT = ".png,.jpg,.jpeg,.webp,.bmp,.gif,.tiff";

app.registerExtension({
    name: "NM.GrokMultiImage",
...
function setupMultiImage(node) {
    ...
    node.addDOMWidget("grok_multi_image", "div", container, {
        serialize: false,
        getMinHeight: () => 240,
    });
